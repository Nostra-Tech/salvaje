...
import {
  X, Dumbbell, ClipboardList, Shield, Bell, BarChart3,
  History, Settings, TrendingUp, LogOut, User, MessageSquare, Video,
} from 'lucide-react'
...
const moreItems = [
  ...
  { to: '/admin/videos',        icon: Video,         label: 'Videos de Recomendación' },
  { to: '/admin/feedback',      icon: MessageSquare, label: 'Opiniones (encuesta cortesía)' },
...
export function AdminMoreDrawer({ open, onClose }) {
              ...
              <div className="mt-5 pt-4 border-t border-salvaje-cream">
                <div className="flex items-center gap-3 px-1 mb-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-body text-sm font-semibold text-salvaje-dark truncate">{profile?.displayName || 'Admin'}</p>
